...
describe('Wallet', () => {
  ...
  describe('when the user types into the wallet input', () => {
    ...
    it('updates the local balance in the `state` and it converts it to a number', () => {
      expect(wallet.state().balance).toEqual(parseInt(userBalance, 10));
    });

    describe('and the user clicks the deposit button', () => {
      beforeEach(() => {
    ...
    describe('and the user clicks the withdraw button', () => {
      beforeEach(() => {
